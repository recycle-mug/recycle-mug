...
public class JwtFilter extends GenericFilterBean {
    ...
    public JwtFilter(TokenAuthenticationProvider tokenAuthenticationProvider) {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (StringUtils.hasText(jwt) && tokenAuthenticationProvider.validateToken(jwt)) {
            Authentication authentication = tokenAuthenticationProvider.getAuthentication(jwt);
